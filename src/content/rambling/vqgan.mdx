...
import modeling from "./images/vqgan/modeling.png"
import l2 from "./images/vqgan/l2.png"
...
- [Training the full model](#training-the-full-model)
...
<div class="center my-12">
	<div class="p-2">![compression](./images/vqgan/compression.png)</div>
	<span class="text-sm opacity-80 text-center">VQVAE compresses data into tokens and decompresses back</span>
</div>
...
<div class="center my-12">
	<div class="p-2"><Image src={modeling} alt="modeling" /></div>
	<span class="text-sm opacity-80 text-center">Modeling data with discrete tokens enables language model techniques</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![one](./images/vqgan/one.png)</div>
	<span class="text-sm opacity-80 text-center">Step 1: Encoder extracts features from the input image</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![two](./images/vqgan/two.png)</div>
	<span class="text-sm opacity-80 text-center">Step 2: Codebook quantization - finding closest vectors</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![three](./images/vqgan/three.png)</div>
	<span class="text-sm opacity-80 text-center">Step 3: Decoder reconstructs the image from quantized vectors</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![close](./images/vqgan/close.png)</div>
	<span class="text-sm opacity-80 text-center">Two approaches to training the codebook</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![commit](./images/vqgan/commit.png)</div>
	<span class="text-sm opacity-80 text-center">Commitment loss between the encoder's output and the codebook's vectors</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![vq](./images/vqgan/vq.png)</div>
	<span class="text-sm opacity-80 text-center">VQ loss pulls codebook vectors closer to encoder output</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![straight](./images/vqgan/straight.png)</div>
	<span class="text-sm opacity-80 text-center">Straight-through estimator allows gradients to flow through quantization</span>
</div>
...
<div class="center my-12">
	<div class="p-2 w-1/3"><Image src={l2} alt="l2" /></div>
	<span class="text-sm opacity-80 text-center">All the surrounding images have the same L2 distance</span>
</div>
...
<div class="center my-12">
	<div class="p-2"><Image src={mode} alt="mode" /></div>
	<span class="text-sm opacity-80 text-center">When your neural network takes the easy way out...</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![results](./images/vqgan/winner.png)</div>
	<span class="text-sm opacity-80 text-center">CNN backbone outperforms Attention and Mamba backbones</span>
</div>
...
<div class="center my-12">
	<div class="p-2"><Image src={teaser} alt="teaser" /></div>
	<span class="text-sm opacity-80 text-center">Comparison of reconstructions and initialisation for different VQVAE backbones</span>
</div>
...
<div class="center my-12">
	<div class="p-2"><Image src={grid} alt="grid" /></div>
	<span class="text-sm opacity-80 text-center">Grid artifacts in Mamba and Attention backbones</span>
</div>
...
<div class="center my-12">
	<div class="p-2"><Image src={fix} alt="fix" /></div>
	<span class="text-sm opacity-80 text-center">Fixing grid artifacts with overlapping patches and extra convolutional layers</span>
</div>
