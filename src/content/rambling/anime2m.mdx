...
<div class="center my-12">
	<div class="p-2">![animefaces2m](./images/anime2m/activeloop/animefaces.png)</div>
	<span class="text-sm opacity-80 text-center"><a href="https://activeloop.ai/datasets/animefaces-2m">Animefaces 2M dataset</a></span>
</div>
...
<div class="center my-12">
	<div class="p-2">![pipeline](./images/anime2m/animefaces2m.png)</div>
	<span class="text-sm opacity-80 text-center">Data cleaning and processing pipeline for anime2m dataset</span>
</div>
