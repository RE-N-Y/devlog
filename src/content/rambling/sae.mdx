...
<div className="my-12 center">
    ...
    You can access 🔗 [fluxlens here](https://fluxlens.vercel.app) to explore the features of Sparse Autoencoders.
</div>

<span className="text-sm opacity-80">Note: This is a long-term ongoing research project I will be updating as I make progress. I plan to open source my SAE training code and weights in the coming weeks. I welcome any feedback, suggestions, or collaboration. Please reach out!</span>
...
<div className="center p-2">
    ...
    <span className="text-xl font-semibold">CC3M dataset visualisation.</span>
    <p>Click to explore 🔗 [fluxlens](https://fluxlens.vercel.app)</p>
</div>
...
<div className="center p-2">
    ...
    Steering results using CLIP SAE features
</div>
