...
<div class="center my-12">
	<div class="p-2">![teaser](./images/steering/hairbun.gif)</div>
	<span class="text-sm opacity-80 text-center">Linear interpolation of hairbun vector from $0$ ~ $24$</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![flux redux](./images/steering/bread.png)</div>
	<span class="text-sm opacity-80 text-center">flux redux allows users to condition the model on an image, allowing users to create variations - [source](https://blackforestlabs.ai/flux-1-tools/)</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![mmdit](./images/steering/flux.png)</div>
	<span class="text-sm opacity-80 text-center">Simplified schematic of flux architecture. flux has two variants of MMDiT blocks, a double stream block which processes text and image embeddings in parallel and a single stream block which processes text and image embeddings as a single sequence.</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![redux](./images/steering/redux.png)</div>
	<span class="text-sm opacity-80 text-center">Conditioning with SigLIP embeddings in flux redux</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![fuyu](./images/steering/fuyu.png)</div>
	<span class="text-sm opacity-80 text-center">Fuyu architecture - [source](https://www.adept.ai/blog/fuyu-8b)</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![interface](./images/steering/interface.png)</div>
	<span class="text-sm opacity-80 text-center">Annotated interface for SigLIP SAE - [source](https://fluxlens.vercel.app/sae/long/cc3m-siglip-vision-topk-lr-3e-4-k-16-expansion-4-acts)</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![patches](./images/steering/patches.png)</div>
</div>
...
<div class="center my-12">
	<div class="p-2">![vectors](./images/steering/vectors.png)</div>
	<span class="text-sm opacity-80 text-center">The colored patch represents the strength of the steering vector in the patch</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![steering](./images/steering/teaser.png)</div>
	<span class="text-sm opacity-80 text-center">Steering with SigLIP SAE + flux redux</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![clamp](./images/steering/clamp.png)</div>
	<span class="text-sm opacity-80 text-center">Suppressing concepts by clamping the feature vector</span>
</div>
...
<div class="center my-12">
	<div class="p-2 w-2/3">![negative](./images/steering/negative.png)</div>
	<span class="text-sm opacity-80 text-center">Suppressing concepts by setting the feature vector to negative values</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![add](./images/steering/add.png)</div>
	<span class="text-sm opacity-80 text-center">Introducing new concepts by increasing the strength of the feature vector</span>
</div>
...
<div class="center my-12">
	<div class="p-2">![getty](./images/steering/getty.png)</div>
	<span class="text-sm opacity-80 text-center">Getty images watermark vector</span>
</div>
...
<div class="center my-12">
	<div class="p-2 w-2/3">![compose](./images/steering/compose.png)</div>
	<span class="text-sm opacity-80 text-center">Composing images with different concepts</span>
</div>
